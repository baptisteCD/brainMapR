...
atlas<-vroom(system.file("extdata/atlas", "Atlas_coordinates_ROI_subortical.txt", package = "brainMapR",mustWork = TRUE), show_col_types = FALSE,  progress = FALSE, col_types = cols() )
